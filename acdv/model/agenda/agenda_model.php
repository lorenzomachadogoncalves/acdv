<?php
    ...
    project_require('conexaoBD.php');

    function cadastrar_programacao($id_participante, $id_oficina, $dia_semana, $inicio, $fim) {
        try {
            connect();
            global $conexao;
    ...
    function visualizar_programacao() {
        connect();
        global $conexao;

        $sql = "SELECT part.nome, ofi.nome, ag.dia_semana, ag.horario_inicio, ag.horario_fim FROM agenda ag
    ...
    function editar_programacao($id_participante, $id_oficina, $dia_semana, $inicio, $fim, $id_programacao) {
        try {
            connect();
            global $conexao;
