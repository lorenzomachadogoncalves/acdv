<?php
    ...
    function visualizar_contribuicao() {
        connect();
        $resultado = query("SELECT * FROM contribuicao");
        close();
    ...
    function editar_contribuicao($id_associado, $data_pagamento, $valor, $metodo_pagamento, $id_contribuicao) {
        connect();
        query("UPDATE contribuicao SET id_associado = $id_associado, valor = $valor, 
